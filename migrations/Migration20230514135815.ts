...
export class Migration20230514135815 extends Migration {

  async up(): Promise<void> {
    this.addSql('create table "category" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "name" varchar(255) not null, "description" varchar(255) not null);');
    ...
    this.addSql('create table "conversation" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "chat_name" varchar(255) not null);');
    ...
    this.addSql('create table "news_letter" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "email" varchar(255) not null);');
    ...
    this.addSql('create table "protocol" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "login_attemptnumbererval" int not null, "loginnumbererval_unit" varchar(255) not null, "login_max_retry" int not null, "otp_expiry_in_minutes" int not null);');
    this.addSql('create index "protocol_id_index" on "protocol" ("id");');
    this.addSql('create index "protocol_idx_index" on "protocol" ("idx");');

    this.addSql('create table "tag" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "title" varchar(50) not null, "description" varchar(255) not null, "slug" varchar(255) null);');
    ...
    this.addSql('create table "refresh_token" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "expires_in" timestamptz(0) not null, "user_id" int not null, "is_revoked" boolean not null default false);');
    ...
    this.addSql('create table "otp_log" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "expires_in" timestamptz(0) not null, "otp_code" varchar(20) null, "user_id" int not null, "is_used" boolean not null);');
    ...
    this.addSql('create table "message" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "body" varchar(255) not null, "sender_id" int not null, "conversation_id" int not null, "is_read" boolean not null default false, "read_at" timestamptz(0) null);');
    ...
    this.addSql('create table "comment" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_deleted" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "body" varchar(255) not null, "post_id" int not null, "author_id" int not null);');
