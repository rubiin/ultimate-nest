...
export class Migration20240928082509 extends Migration {
  override async up(): Promise<void> {
    this.addSql(
      `create table "category" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "name" varchar(255) not null, "description" varchar(255) not null);`,
    );
    ...
    this.addSql(
      `create table "conversation" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "chat_name" varchar(255) not null);`,
    );
    ...
    this.addSql(
      `create table "news_letter" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "name" varchar(255) not null, "content" text not null, "sent_at" timestamptz null);`,
    );
    ...
    this.addSql(
      `alter table "news_letter" add constraint "news_letter_name_unique" unique ("name");`,
    );

    this.addSql(
      `create table "protocol" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "login_attemptnumbererval" int not null, "loginnumbererval_unit" varchar(255) not null, "login_max_retry" int not null, "otp_expiry_in_minutes" int not null);`,
    );
    ...
    this.addSql(
      `create table "subscriber" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "email" varchar(255) not null);`,
    );
    ...
    this.addSql(
      `alter table "subscriber" add constraint "subscriber_email_unique" unique ("email");`,
    );

    this.addSql(
      `create table "tag" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "title" varchar(50) not null, "description" text not null, "slug" varchar(255) null);`,
    );
    ...
    this.addSql(
      `create table "refresh_token" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "expires_in" timestamptz not null, "user_id" int not null, "is_revoked" boolean not null default false);`,
    );
    ...
    this.addSql(
      `create table "referral" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "referrer_id" int not null, "mobile_number" varchar(255) not null, "status" text check ("status" in ('PENDING', 'COMPLETED')) not null default 'PENDING');`,
    );
    ...
    this.addSql(
      `create table "post_categories" ("post_id" int not null, "category_id" int not null, constraint "post_categories_pkey" primary key ("post_id", "category_id"));`,
    );
    ...
    this.addSql(
      `create table "otp_log" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "expires_in" timestamptz not null, "otp_code" varchar(20) null, "user_id" int not null, "is_used" boolean not null default false);`,
    );
    ...
    this.addSql(
      `create table "message" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "body" varchar(255) not null, "sender_id" int not null, "conversation_id" int not null, "is_read" boolean not null default false, "read_at" timestamptz null);`,
    );
    ...
    this.addSql(
      `create table "comment" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz null, "created_at" timestamptz null, "updated_at" timestamptz null, "body" varchar(255) not null, "post_id" int not null, "author_id" int not null);`,
    );
    ...
    this.addSql(
      `create table "user_conversations" ("user_id" int not null, "conversation_id" int not null, constraint "user_conversations_pkey" primary key ("user_id", "conversation_id"));`,
    );

    this.addSql(
      `create table "user_favorites" ("user_id" int not null, "post_id" int not null, constraint "user_favorites_pkey" primary key ("user_id", "post_id"));`,
    );

    this.addSql(
      `create table "user_to_follower" ("follower" int not null, "following" int not null, constraint "user_to_follower_pkey" primary key ("follower", "following"));`,
    );
    ...
    this.addSql(
      `alter table "referral" add constraint "referral_referrer_id_foreign" foreign key ("referrer_id") references "user" ("id") on update cascade;`,
    );
    ...
    this.addSql(
      `alter table "post_categories" add constraint "post_categories_post_id_foreign" foreign key ("post_id") references "post" ("id") on update cascade on delete cascade;`,
    );
    this.addSql(
      `alter table "post_categories" add constraint "post_categories_category_id_foreign" foreign key ("category_id") references "category" ("id") on update cascade on delete cascade;`,
    );
    ...
    this.addSql(
      `alter table "user_conversations" add constraint "user_conversations_user_id_foreign" foreign key ("user_id") references "user" ("id") on update cascade on delete cascade;`,
    );
    this.addSql(
      `alter table "user_conversations" add constraint "user_conversations_conversation_id_foreign" foreign key ("conversation_id") references "conversation" ("id") on update cascade on delete cascade;`,
    );
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(
      `alter table "user_conversations" drop constraint "user_conversations_conversation_id_foreign";`,
    );
    ...
    this.addSql(
      `alter table "point_redemption_log" drop constraint "point_redemption_log_user_id_foreign";`,
    );
    ...
    this.addSql(
      `alter table "user_conversations" drop constraint "user_conversations_user_id_foreign";`,
    );
