...
export class Migration20230527141415 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "user" ("id" serial primary key, "idx" varchar(255) null, "is_active" boolean null default true, "is_deleted" boolean null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) null, "updated_at" timestamptz(0) null, "first_name" varchar(255) not null, "middle_name" varchar(255) null, "last_name" varchar(255) not null, "username" varchar(255) not null, "email" varchar(255) not null, "bio" text not null, "avatar" text not null, "password" text not null, "two_factor_secret" varchar(255) null, "is_two_factor_enabled" boolean null default false, "roles" text[] null default \'{AUTHOR}\', "mobile_number" varchar(255) null, "is_verified" boolean null default false, "social" jsonb null, "last_login" timestamptz(0) null);');
