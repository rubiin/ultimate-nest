...
export class Migration20210228134739 extends Migration {
	async up(): Promise<void> {
		this.addSql(`CREATE EXTENSION IF NOT EXISTS "uuid-ossp";`);
		this.addSql(
			'create table "user" ("id" serial primary key, "idx" varchar(255) not null default uuid_generate_v4(), "is_active" bool not null default true, "is_obsolete" bool not null default false, "created_at" timestamptz(0) not null default CURRENT_TIMESTAMP, "updated_at" timestamptz(0) null default CURRENT_TIMESTAMP, "first_name" varchar(50) not null, "middle_name" varchar(50) null, "last_name" varchar(50) not null, "email" varchar(50) not null, "password" varchar(255) not null, "street" varchar(255) not null, "apartment" varchar(255) not null, "city" varchar(255) not null, "zip" varchar(255) not null, "country" varchar(255) not null, "phone" varchar(255) not null, "is_admin" bool not null);',
		);
		this.addSql(
		...
		this.addSql(
			'create table "order_items" ("id" serial primary key, "idx" varchar(255) not null default uuid_generate_v4(), "is_active" bool not null default true, "is_obsolete" bool not null default false, "created_at" timestamptz(0) not null default CURRENT_TIMESTAMP, "updated_at" timestamptz(0) null default CURRENT_TIMESTAMP, "quantity" int4 not null default 0);',
		);

		this.addSql(
			'create table "order" ("id" serial primary key, "idx" varchar(255) not null default uuid_generate_v4(), "is_active" bool not null default true, "is_obsolete" bool not null default false, "created_at" timestamptz(0) not null default CURRENT_TIMESTAMP, "updated_at" timestamptz(0) null default CURRENT_TIMESTAMP, "quantity" int4 not null default 0, "order_item_id" int4 not null);',
		);
		this.addSql(
			'alter table "order" add constraint "order_order_item_id_unique" unique ("order_item_id");',
		);
		...
		this.addSql(
			'alter table "order" add constraint "order_order_item_id_foreign" foreign key ("order_item_id") references "order_items" ("id") on update cascade;',
		);
