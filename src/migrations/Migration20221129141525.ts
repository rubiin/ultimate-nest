...
export class Migration20221129141525 extends Migration {
	async up(): Promise<void> {
		...
		this.addSql(
			'create table "user" ("id" serial primary key, "idx" varchar(255) not null, "is_active" boolean not null default true, "is_obsolete" boolean not null default false, "deleted_at" timestamptz(0) null, "created_at" timestamptz(0) not null, "updated_at" timestamptz(0) null, "first_name" varchar(255) not null default \'\', "last_name" varchar(255) not null default \'\', "username" varchar(255) not null, "email" varchar(255) not null, "avatar" varchar(255) not null, "password" varchar(255) not null, "roles" text[] not null default \'{AUTHOR}\', "mobile_number" varchar(255) null, "is_verified" boolean not null default false);',
		);
		this.addSql(
