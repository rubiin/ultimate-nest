...
constructor(
  @InjectRepository(Conversation) private readonly conversationRepository: BaseRepository<Conversation>,
...
if(conversationExists){
  ...
  await Promise.all([ this.messageRepository.persistAndFlush(messageNew),this.conversationRepository.flush()])
}
else {
